...
import {Moodle, ERR_INVALID_CREDENTIALS, ERR_NO_CREDENTIALS} from '../../src/shared/moodle-functions-v3/moodle.js';
import {getUsername, getToken} from '../../src/shared/moodle-functions-v3/credentials.js';
